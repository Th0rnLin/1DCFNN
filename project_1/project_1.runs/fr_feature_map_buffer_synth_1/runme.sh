...
HD_PWD='E:/Zedboard/1DCFNN/project_1/project_1.runs/fr_feature_map_buffer_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fr_feature_map_buffer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fr_feature_map_buffer.tcl
