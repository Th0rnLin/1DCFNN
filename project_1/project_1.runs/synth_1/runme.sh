...
HD_PWD='E:/Zedboard/1DCFNN/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CFNN_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CFNN_top.tcl
