...
HD_PWD='E:/Zedboard/1DCFNN/project_1/project_1.runs/df_output_buffer_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log df_output_buffer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source df_output_buffer.tcl
