...
HD_PWD='E:/Zedboard/1DCFNN/project_1/project_1.runs/df_mult_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log df_mult.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source df_mult.tcl
