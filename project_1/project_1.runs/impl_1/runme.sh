...
HD_PWD='E:/Zedboard/1DCFNN/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CFNN_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CFNN_top.tcl -notrace
