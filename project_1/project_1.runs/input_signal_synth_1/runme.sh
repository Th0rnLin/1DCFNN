...
HD_PWD='E:/Zedboard/1DCFNN/project_1/project_1.runs/input_signal_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log input_signal.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source input_signal.tcl
