...
#
# Generated by export_simulation on Sun Oct 09 15:30:15 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './input_signal.sh' script.

./input_signal.sh -reset_run
...
./input_signal.sh -noclean_files

For more information on the script, please type './input_signal.sh -help'.
