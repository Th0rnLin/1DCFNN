...
HD_PWD='E:/Zedboard/1DCFNN/1DCFNN_SYSTEM/1DCFNN_SYSTEM.runs/design_1_OneDCFNN_IP_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_OneDCFNN_IP_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_OneDCFNN_IP_0_2.tcl
